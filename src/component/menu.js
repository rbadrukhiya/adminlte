    ...
    return (
        <>
            <div className="preloader flex-column justify-content-center align-items-center">
                <img className="animation__wobble" src={require('../img/AdminLTELogo.png')} alt="AdminLTELogo" height={60} width={60} />
            </div>
            <nav className="main-header navbar navbar-expand navbar-dark">
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item d-none d-sm-inline-block">
                        <a href="/admin" onClick={logout } className="nav-link">logout</a>
                    </li>
                </ul>
                        ...
                        <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            <li className="nav-item menu-open">
                                ...
                                <ul className="nav nav-treeview">
                                    ...
                                    <li className="nav-item">
                                        <a href="/dashboard2" className="nav-link active">
                                            <i className="far fa-circle nav-icon" />
                                            <p>Dashboard v2</p>
                                        </a>
                                    </li>
                            ...
                            <li className="nav-item">
                                ...
                                <ul className="nav nav-treeview">
                                    <li className="nav-item">
                                        <a href="/top-navigation" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                                            <p>Top Navigation</p>
                                        </a>
                                    </li>
                                    <li className="nav-item">
                                        <a href="/top-navigation-sidebar" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                                    ...
                                    <li className="nav-item">
                                        <a href="/fix-sidebar" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                                            <p>Fixed Sidebar</p>
                                        </a>
                                    </li>
                                    <li className="nav-item">
                                        <a href="/fix-sidebar-custom-area" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                                            <p>Fixed Sidebar <small>+ Custom Area</small></p>
                                        </a>
                                    </li>
                                    <li className="nav-item">
                                        <a href="fix-navbar" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                                            <p>Fixed Navbar</p>
                                        </a>
                                    </li>
                                    <li className="nav-item">
                                        <a href="/fix-footer" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                                            <p>Fixed Footer</p>
                                        </a>
                                    </li>
                                    <li className="nav-item">
                                        <a href="/collapsed-sidebar" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                            ...
                            <li className="nav-item">
                                ...
                                <ul className="nav nav-treeview">
                                    ...
                                    <li className="nav-item">
                                        <a href="/float" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                                            <p>Flot</p>
                                        </a>
                                    </li>
                                    ...
                                    <li className="nav-item">
                                        <a href="/uploat" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                                            <p>uPlot</p>
                                        </a>
                                    </li>
                            ...
                            <li className="nav-item">
                                ...
                                <ul className="nav nav-treeview">
                                    <li className="nav-item">
                                        <a href="general-elements" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                                            <p>General Elements</p>
                                        </a>
                                    </li>
                                    <li className="nav-item">
                                        <a href="/advance_elements" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                            ...
                            <li className="nav-item">
                                ...
                                <ul className="nav nav-treeview">
                                    {/* <li className="nav-item">
                                        <a href="/simple-table" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                                            <p>Simple Tables</p>
                                        </a>
                                    </li> */}
                                    <li className="nav-item">
                                        <a href="/data-table" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                                            <p>DataTables</p>
                                        </a>
                                    </li>

              ...
              <div className="row">
                  ...
                  <div className="card card-widget widget-user-2">
                    ...
                    <div className="widget-user-header bg-warning">
                      <div className="widget-user-image">
                        <img className="img-circle elevation-2" src={require('../img/user7-128x128.jpg')} alt="User Avatar" />
                      </div>
                      {/* /.widget-user-image */}
                ...
                <div className="col-md-4">
                  ...
                  <div className="card card-widget widget-user">
                    ...
                    <div className="widget-user-image">
                      <img className="img-circle elevation-2" src={require('../img/user1-128x128.jpg')} alt="User Avatar" />
                    </div>
                    <div className="card-footer">
                      <div className="row">
                ...
                <div className="col-md-4">
                  ...
                  <div className="card card-widget widget-user">
                    ...
                    <div className="widget-user-image">
                      <img className="img-circle" src={require('../img/user3-128x128.jpg')} alt="User Avatar" />
                    </div>
                    <div className="card-footer">
                      <div className="row">
                        <div className="col-sm-4 border-right">
                  ...
                  <div className="card card-widget">
                    <div className="card-header">
                      <div className="user-block">
                        <img className="img-circle" src={require('../img/user1-128x128.jpg')} alt="User Image" />
                    ...
                    {/* /.card-header */}
                    <div className="card-body">
                      <img className="img-fluid pad" src={require('../img/photo2.png')} alt="Photo" />
                    ...
                    <div className="card-footer card-comments">
                      <div className="card-comment">
                        {/* User image */}
                        <img className="img-circle img-sm" src={require('../img/user3-128x128.jpg')} alt="User Image" />
                      ...
                      <div className="card-comment">
                        {/* User image */}
                        <img className="img-circle img-sm" src={require('../img/user4-128x128.jpg')} alt="User Image" />
                        <div className="comment-text">
                          <span className="username">
                            Luna Stark
                            <span className="text-muted float-right">8:03 PM Today</span>
                    ...
                    <div className="card-footer">
                      <form action="#" method="post">
                        <img className="img-fluid img-circle img-sm" src={require('../img/user4-128x128.jpg')} alt="Alt Text" />
                  ...
                  <div className="card card-widget">
                    ...
                    <div className="card-body">
                      ...
                      <div className="attachment-block clearfix">
                        <img className="attachment-img" src={require('../img/photo1.png')} alt="Attachment Image" />
                    ...
                    <div className="card-footer card-comments">
                      ...
                      <div className="card-comment">
                        <img className="img-circle img-sm" src={require('../img/user5-128x128.jpg')} alt="User Image" />
                        <div className="comment-text">
                          <span className="username">
                            Nora Havisham
                            <span className="text-muted float-right">8:03 PM Today</span>
                  ...
                  <div className="row">
                    <div className="col-md-12 col-lg-6 col-xl-4">
                      <div className="card mb-2 bg-gradient-dark">
                        <img className="card-img-top" src={require('../img/photo1.png')} alt="Dist Photo 1" />
                    ...
                    <div className="col-md-12 col-lg-6 col-xl-4">
                      <div className="card mb-2">
                        <img className="card-img-top" src={require('../img/photo2.png')} alt="Dist Photo 2" />
                    ...
                    <div className="col-md-12 col-lg-6 col-xl-4">
                      <div className="card mb-2">
                        <img className="card-img-top" src={require('../img/photo3.jpg')} alt="Dist Photo 3" />
